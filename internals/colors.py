...
def color_test(bot):
    print(
    f"{bot.CYAN_B}Color test: " +
    f"{bot.BLACK}#"   + f"{bot.BLACK_B}#" +
    f"{bot.RED}#"     + f"{bot.RED_B}#" +
    f"{bot.GREEN}#"   + f"{bot.GREEN_B}#" +
    f"{bot.YELLOW}#"  + f"{bot.YELLOW_B}#" +
    f"{bot.BLUE}#"    + f"{bot.BLUE_B}#" +
    f"{bot.MAGENTA}#" + f"{bot.MAGENTA_B}#" +
    f"{bot.CYAN}#"    + f"{bot.CYAN_B}#" +
    f"{bot.WHITE}#"   + f"{bot.WHITE_B}#" +
    f"{bot.RESET}"    + " RESET")
