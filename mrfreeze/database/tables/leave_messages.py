"""Trash channels stores information about which leave messages servers use."""
...
class LeaveMessages(ABCTableDict[int, Optional[str]]):
    """Class for handling the welcome_messages table."""

    def __init__(self, dbpath: str, logger: logging.Logger) -> None:
        self.dbpath = dbpath
        self.name = "leave messages"
        self.table_name = "leave_messages"
        self.dict = None
        self.logger = logger
